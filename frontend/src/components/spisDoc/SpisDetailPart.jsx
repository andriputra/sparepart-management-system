    ...
    return (
        <table className="w-full border border-gray-500 text-sm mb-6">
            ...
            {detailPartImage.length > 0 ? (
                ...
                <tr key={index}>
                    <td className="border border-gray-500 p-3 w-[30%] text-center">
                        <img
                    ...
                    <td className="border border-gray-500 p-4 align-top">
                        {item.description || "-"}
                    </td>
                </tr>
                ))
                ...
                <tr>
                    <td
                        colSpan="2"
                        className="border border-gray-500 p-4 text-center text-gray-500 italic"
                    >
